...
$empfaenger = "office@sama-consult.at"; //Empfänger-Adresse
$mail_cc = ""; //CC-Adresse, diese E-Mail-Adresse bekommt einer weitere Kopie
$betreff = "Neue Kontaktanfrage"; //Betreff der Email

$url_ok = "http://sama-test.000webhostapp.com/index.html"; //Zielseite, wenn E-Mail erfolgreich versendet wurde
$url_fehler = "http://sama-test.000webhostapp.com/contact.html"; //Zielseite, wenn E-Mail nicht gesendet werden konnte
